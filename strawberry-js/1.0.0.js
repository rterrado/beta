...
$patch:function(args,contextObj){
    ...
    strawberry.$getComponentFrom(document,contextObj.getName()).innerHTML = '';

    // Apends the template to the DOM
    bind_element(patchTemplate.childNodes[0],strawberry.$getComponentFrom(document,contextObj.getName()));
